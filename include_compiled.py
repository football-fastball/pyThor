...
""").initsupers(locals(),globals()).format( source_code_htmlentities_form = python_php_htmlentities( source_code() ) ) # note: at this time not to double htmlentities process
